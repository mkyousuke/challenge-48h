...
// Fonction qui encapsule la fonctionnalité du premier programme
func executerPremierProgramme() {
    fonctions.LaunchApp()
    ...
    // 2. Create a file in that directory with LaunchApp function
}
 
func generatePDF() {
    // Intégration de la fonctionnalité du premier programme
    executerPremierProgramme()
...
func main() {
    // Exécution du premier programme en parallèle
    go executerPremierProgramme()
    
    // Configuration du serveur web du second programme
